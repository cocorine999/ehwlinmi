...
class PrioritiesController extends Controller
{
    public function index()
    {
        ...
        return view('dash.tickets.priorities.index', compact('priorities'));
    }
    ...
    public function create()
    {
        ...
        return view('dash.tickets.priorities.create');
    }
    ...
    public function store(StorePriorityRequest $request)
    {
        ...
        return redirect()->route('dash.tickets.priorities.index');
    }
    ...
    public function edit(Priority $priority)
    {
        ...
        return view('dash.tickets.priorities.edit', compact('priority'));
    }
    ...
    public function show(Priority $priority)
    {
        ...
        return view('dash.tickets.priorities.show', compact('priority'));
    }
