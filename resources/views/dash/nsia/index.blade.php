...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">NSIA Vie</h3>
            @hasanyrole(config('custom.roles.ITNSIA'))
            <div class="card-tools">
                <a href="{{route('nsia.create')}}" type="button" class="btn btn-primary float-right" title="Ajouter un utilisateur">
