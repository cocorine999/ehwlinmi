	...
	<div class="col-md-12">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Ajout de Prospect</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form autocomplete="off" action="{{route('prospects.store')}}" method="POST" role="form" >
                  @csrf
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- text input -->
                      <div class="form-group">
		                   ...
		                   <input type="text" class="form-control" id="nom" value="{{ old('nom') }}" name="nom" placeholder="Nom">
		              </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
		                   <label for="forPrenom">Prénom</label>
		                   <input type="text" class="form-control" id="prenom" value="{{ old('prenom') }}" name="prenom" placeholder="Prenom">
		               </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
	                    ...
	                    <input type="text" class="form-control" id="telephone" value="{{ old('telephone') }}" name="telephone" placeholder="Téléphone">
	                  </div>
                    </div>
