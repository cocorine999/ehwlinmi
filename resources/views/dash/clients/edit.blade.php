...
@section('pagetitle', "Ajouter un souscripteur")
@section('styles')
    ...
    @csrf
        ...
        <div class="row">  
          <div class="form-group col-md-6">
            ...
            <input required type="password" class="form-control" id="InputPassword1" name="password" placeholder="Confirmer mot de passe">
          </div>
          <div class="form-group col-md-6">
            <label for="InputPassword2">Confirmation du mot de passe *</label>
            <input required type="password" class="form-control" id="InputPassword2" name="confirm_password" placeholder="Confirmer mot de passe">
          </div>
        </div>
      <!-- /.card-body -->
    ...
    function setup(valeur){
      ...
      personnephysique =         '<div class="row">'+
          '<div class="form-group col-md-4">'+
            ...
            '<input required type="date" class="form-control" id="InputNaissance" onchange="age(this)"  class="telcheck"name="date_naissance" placeholder="Entrer date de naissance">'+
          '</div>'+
          '<div class="form-group col-md-4">'+
            '<label>Sexe *</label>'+
          ...
          '<div class="form-group col-md-4">'+
            ...
            '<select required class="form-control select2bs4" id="situationmatrimoniale" name="situation_matrimoniale">'+
              '<option value="" selected disabled>Choisissez une option...</option>'+
              '<option>Choisissez votre situation Matrimoniale</option>'+
